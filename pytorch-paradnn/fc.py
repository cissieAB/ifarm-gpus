...
class HyperParams:
    ...
    def get_ops(self):
        return self.steps * self.batch_size * \
               self.get_num_params() * 6  # FWD 2x(#NN params) and BWD 4x(#NN params)
...
class Net:
    ...
    def __init__(self, params):
        ...
        self.optimizer = torch.optim.RMSprop(
            ...
            lr=ParaDnnRMSProp.LR,
            eps=ParaDnnRMSProp.EPS,
            weight_decay=ParaDnnRMSProp.DECAY,
            momentum=ParaDnnRMSProp.MOMENTUM
        )  # ParaDnn optimizer params differ from PyTorch defaults
...
def benchmark_wrapper(hyperparams):
    ...
    Other domain will be passed by the (external) bash script.
    """
